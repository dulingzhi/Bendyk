...
int main(int argc, char**argv)
{
    ...
    io.Fonts->AddFontFromFileTTF("C:/Windows/fonts/msyh.ttc", 16.0f, nullptr, ranges.Data);
    io.Fonts->Build();
...

        {
            ...
            if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None)) {
                ...
                if (ImGui::BeginTabItem("SQL")) {
                    ...
                    if (result) {
                        ImGui::Text(u8"结果：%d行，%d列", result_rows, result_cols);
                ...
                if (ImGui::BeginTabItem(u8"数据")) {
                    ...
                    if (rc != SQLITE_OK) {
                        ...
                        ImGui::Combo(u8"数据表", &selected_table_index, &result[1], rows);
                ...
                if (ImGui::BeginTabItem(u8"浏览")) {
                    ...
                    if (rc != SQLITE_OK) {
                        ...
                        if (rc != SQLITE_OK) {
                            ...
                            ImGui::Text(u8"记录：%d/%d", record_index, rows);
                            ImGui::SameLine();
                            if (ImGui::Button(u8"上一条")) {
                                record_index--;
                                if (record_index<1) record_index=rows;
                            }
                            ImGui::SameLine();
                            if (ImGui::Button(u8"下一条")) {
                                record_index++;
                                if (record_index>rows) record_index=1;
                            }

                            ImGui::SliderInt(u8"序号", &record_index, 1, rows);
